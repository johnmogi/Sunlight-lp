...
class GalleryConfig
{
    private static array $translations = [
        ...
        'fr' => [
            ...
            'feedback' => [
                ...
                'view_image_label' => 'Voir l’image',
                'modal_title' => 'Donnez votre ressenti',
                'modal_subtitle' => 'Dites-nous ce que vous pensez de « %s »',
        ...
        'es' => [
            ...
            'feedback' => [
                ...
                'view_image_label' => 'Ver imagen',
                'modal_title' => 'Cuéntanos qué sientes',
                'modal_subtitle' => 'Cuéntanos qué piensas sobre «%s»',
        ...
        'he' => [
            ...
            'feedback' => [
                ...
                'view_image_label' => 'הצגת תמונה',
                'modal_title' => 'איך זה מרגיש לכם?',
                'modal_subtitle' => 'ספרו לנו מה אתם חושבים על "%s"',
    ...
    private static function defaultFeedbackStrings(): array
    {
        return [
            ...
            'modal_subtitle' => __('Tell us what you think about "%s"', 'cta'),
            ...
            'view_image_label' => __('View image', 'cta'),
